...
class App:
    ...
    def _load_random_img(self):
            ...
            for img, label in testloader:
                ...
                st.session_state["img_tensor"] = img.unsqueeze(0)
    ...
    def _render_model_selection(self):
        ...
        if predict and true_label is not None: 
            self._predict(true_label, toggle_teacher, toggle_student)
    ...
    def _create_canvas(self):
        ...
        with features_col:
            ...
            if img_tensor is not None:
                if not random_img_button:
                    st.session_state["img_tensor"] = self.manager.transform_img(img_tensor)
                else:
